...
class CommunicationLayerTests(unittest.TestCase):
    ...
    def test_all_seven_skills_load_core_style_protection_and_handoff(self) -> None:
        actual = {
            item.name
    ...
    def test_runtime_notice_contains_selected_mit_attributions(self) -> None:
        ...
        for snapshot_name in (
            ...
            license_text = (COMMUNICATION_ROOT / "upstream" / snapshot_name).read_text(encoding="utf-8")
            self.assertIn(license_text, notice, snapshot_name)
