...
## Academic beta.2 revision gate

Before modifying a rebuttal package or manuscript, load [revision-protocol.md](../../references/revision-protocol.md) and create `ds-lite.revision-constraints.v1`. Treat new evidence, numbers, citations, theorems, deleted citations, and deleted sections as separately approved effects. Preserve negative results and stop after one bounded response/edit cycle. No autonomous ARIS-style loop is permitted.
