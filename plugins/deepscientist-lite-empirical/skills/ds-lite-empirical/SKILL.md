...
Use this pack only with DeepScientist Lite Core `0.8.1-beta.1`. Before acting, run `python <empirical-plugin>/scripts/ds_lite_empirical.py doctor --core-root <core-plugin>`. A missing or different Core version is `blocked`.
